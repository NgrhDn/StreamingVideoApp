...
<div class="container py-5">
    <h1 class="mb-5 text-center fw-bold text-dark">Video On Demand</h1>
    <div class="row g-4">
        @foreach ($videosByKategori as $kategori)
            <!-- Judul kategori + tombol -->
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h4 class="fw-bold text-dark mb-3 pt-4 border-bottom">{{ $kategori->nama_kategori }}</h4>
                <a href="{{ route('kategori.show', $kategori->id) }}" class="btn btn-sm btn-outline-primary">Lihat Semua</a>
            </div>
            <!-- Grid video (dalam kategori ini) -->
            <div class="row g-4">
